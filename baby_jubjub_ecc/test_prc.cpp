...
void test_lp(){
    ...
    char* rn_x = "7556746915113865448813972525759889018125951566477173710725529054186505499207";
    char* rn_y = "10183356817295904689648541581726234767293559438067867006673908371442877762801";
    int sl = 1;
    int d = 3;
    int n = 10;
    t = clock();
    ...
    unsigned char proof [312];
    t = clock();
    prc_prove_lp(proof, 2, 2, sn_x, sn_y,total_rep, 2+30000000000,2, rep_x, rep_y,block_hash, sl,rn_x, rn_y, d, n);
    t = clock() - t;
    time_used = t/CLOCKS_PER_SEC;
    cout << "prove success--------------------------------------" << endl;
    cout << "prove time used: " << time_used<< endl;
